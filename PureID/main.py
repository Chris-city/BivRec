...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='baby', help='book | taobao')  
    parser.add_argument('--random_seed', type=int, default=3407)
    parser.add_argument('--batch_size', type=int, default=256)
    parser.add_argument('--test_iter', type=int, default=10)
    parser.add_argument('--model_type', type=str, default='MMhard_small', help='DNN | GRU4Rec | MIND | ..') 
    ...
    parser.add_argument("--item_num", default=7500, type=int, help="see main.py: 103993sports |23033cloth |3417ml")
    ...
    if args.p == 'train':
        train(device=device, train_file=train_file, valid_file=valid_file, test_file=test_file, model=model,batch_size=args.batch_size,
              ...
              topN=args.topN, max_iter=args.max_iter, test_iter=args.test_iter,patience=args.patience, exp_name=exp_name)
